...
class StatusesControllerTest < ActionController::TestCase
  ...
  test "should be redirected when trying to create a new status and not logged in" do
    get :new
    assert_response :redirect
    assert_redirected_to new_user_session_path
  end

  test "should get the new status page when logged in" do
    sign_in users(:jason)
    get :new
    assert_response :success
  end
  ...
  test "should be able to create status when logged in" do
    sign_in users(:jason)
  ...
  test "should be able to create status for the current user when logged in" do
    sign_in users(:jason)
